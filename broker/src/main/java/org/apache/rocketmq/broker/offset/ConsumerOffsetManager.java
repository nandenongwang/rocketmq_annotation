...
public class ConsumerOffsetManager extends ConfigManager {
    ...
    //queue的offset是否比存储的消息的最小offset还小
    ...
    //更新consumergroup对topic下queue的offset
    ...
    //查询某consumergroup对topic某个queue的消费哦offset
